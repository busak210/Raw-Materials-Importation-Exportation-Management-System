...
public partial class hs10code : System.Web.UI.Page
{
    Connect c;
    ...
    private void popGrid2()
    {
        ...
        c = new Connect();
        c.shola();
        c.com.CommandText = "SELECT Distinct [HS10] ,upper([CommodityName]) as CommodityName FROM [CommodityDataSummary] ORDER by [CommodityName]";
    ...
    private void popGrid2dpl()
    {
        ...
        c = new Connect();
        c.shola();
        c.com.CommandText = "SELECT Distinct [HS10] ,[CommodityName] FROM [CommodityDataSummary] where CommodityName='" + DropDownList1.Text.ToString() + "' ORDER by [CommodityName]";
        c.adapt.SelectCommand = c.com;
        c.adapt.Fill(c.ds);
        //MessageBox.Show("Data Fetched");
        GridView2.DataSource = c.ds;
    ...
    private void popGriddpl()
    {
        ...
        c = new Connect();
        c.shola();
        c.com.CommandText = "SELECT [Year_R] ,sum(cast([Quantity_KG] as float)) as [Quantity_KG] ,sum(cast([Value_N] as float)) as [Value_N] FROM [CommodityDataSummary] where CommodityName='" + DropDownList1.Text.ToString() + "' group by [Year_R]";
        c.adapt.SelectCommand = c.com;
        c.adapt.Fill(c.ds);
        //MessageBox.Show("Data Fetched");
        GridView1.DataSource = c.ds;
