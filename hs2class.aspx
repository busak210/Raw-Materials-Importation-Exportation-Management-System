<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="hs2class.aspx.cs" Inherits="hs2class" %>
                                                                ...
                                                                <tr>
                                                                    <td class="text-left" style="padding: 4px; margin: 4px; border: medium none #CCCCCC; vertical-align: top;">
                                                                        <table style="padding: 4px; margin: 4px; width: 97%; height: 192px; background-color: #FBFBFB;">
                                                                            <tr>
                                                                                <td class="text-center" colspan="4" style="border: thin groove #FFFFFF; padding: 2px; margin: 2px; background-color: #FFFFFF; "><strong>HS2 Class Codes Records List</strong></td>
                                                                            </tr>
                                                                            <tr>
                                                                                ...
                                                                                <td style="border-style: solid none solid none; border-width: thin; border-color: #CCCCCC; background-color: #FFFFFF;">
                                                                                    <asp:DropDownList ID="DropDownList1" runat="server" AutoPostBack="True" DataSourceID="SqlDataSource1" DataTextField="CommodityClassName" DataValueField="CommodityClassName" Font-Names="Times New Roman" Font-Size="Small" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged" Width="500px" style="font-size: x-small">
                                                                                    </asp:DropDownList>
                                                                                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ttttConnectionString2 %>" SelectCommand="SELECT DISTINCT [CommodityClassName] FROM [CommodityClass] ORDER BY [CommodityClassName]"></asp:SqlDataSource>
                                                                                </td>
                                                                            ...
                                                                            <tr>
                                                                                <td class="text-center" colspan="4" style="height: 250px; vertical-align: top;">&nbsp;
                                                                                    <table class="label-default" style="width: 96%; height: 215px">
                                                                                        ...
                                                                                        <tr>
                                                                                            <td style="padding: 4px; margin: 4px; background-color: #CCCCCC;">
                                                                                                ...
                                                                                                <div style="overflow-y:scroll; height:534px; width:400px;">
                                                                                                <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#CCCCCC" BorderStyle="Solid" BorderWidth="3px" Font-Bold="True" Font-Names="Times New Roman" Font-Size="Medium" ForeColor="#0000CC" Height="205px" style="margin-top: 0px; font-size: small; color: #000000;" Width="442px" PageSize="12" ShowFooter="True">
                                                                                                    <Columns>

                                               
                                                                                                        <asp:BoundField DataField="CommoditClassCode" HeaderText="HS2 CLASS" >
                                                                                                        <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                                                                                        </asp:BoundField>
                                                                                                        <asp:BoundField DataField="CommodityClassName" HeaderText="HS2 CLASS NAMES" />
                                                                                    ...
                                                                                    <asp:Chart ID="myChart" runat="server">
                                                                                       ...
                                                                                       <titles>
                                                                                           <asp:Title Name="Raw Materials Analysis" >
                                                                                            </asp:Title>
                                                                                       </titles>
                                                                                    </asp:Chart>
