<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="hs10code.aspx.cs" Inherits="hs10code" %>
                                        ...
                                        <tr>
                                            ...
                                            <td class="style9" style="padding: 2px; margin: 2px; border: thin ridge #CCCCCC; text-align: left; background-color: #DDDDDD; height: 650px; vertical-align: top; width: 850px;">
                                                <table style="padding: 6px; margin: 6px; width: 98%; border-spacing: 10px; height: 601px;">
                                                    ...
                                                    <tr>
                                                        <td class="text-center" style="padding: 2px; margin: 2px; background-color: #FFFFFF"><strong>IMPORTED RAW MATERIALS &amp; PRODUCTS (COMMODITIES)</strong></td>
                                                    </tr>
                                                    <tr>
                                                        <td style="height: 1px"></td>
                                                    </tr>
                                                    <tr>
                                                        <td style="padding: 2px; margin: 2px; height: 119px">
                                                                ...
                                                                <tr>
                                                                    <td class="text-left" style="padding: 4px; margin: 4px; border: medium none #CCCCCC; vertical-align: top;">
                                                                        <table style="padding: 4px; margin: 4px; width: 97%; height: 192px; background-color: #FBFBFB;">
                                                                            <tr>
                                                                                <td class="text-center" colspan="4" style="border: thin groove #FFFFFF; padding: 2px; margin: 2px; background-color: #FFFFFF; "><strong>HS10 Codes Records List</strong></td>
                                                                            </tr>
                                                                            <tr>
                                                                                ...
                                                                                <td style="border-style: solid none solid none; border-width: thin; border-color: #CCCCCC; background-color: #FFFFFF;">
                                                                                    <asp:DropDownList ID="DropDownList1" runat="server" AutoPostBack="True" DataSourceID="SqlDataSource1" DataTextField="CommodityName" DataValueField="CommodityName" Font-Names="Times New Roman" Font-Size="Large" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged" Width="500px" style="font-size: x-small" Height="22px">
                                                                                    </asp:DropDownList>
                                                                                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ttttConnectionString2 %>" SelectCommand="SELECT DISTINCT [CommodityName] FROM [CommodityDataSummary] ORDER BY [CommodityName]"></asp:SqlDataSource>
                                                                                </td>
                                                                            ...
                                                                            <tr>
                                                                                <td class="text-center" colspan="4" style="height: 250px; vertical-align: top;">&nbsp;
                                                                                    <table class="label-default" style="width: 96%; height: 215px">
                                                                                        ...
                                                                                        <tr>
                                                                                            <td style="padding: 4px; margin: 4px; background-color: #CCCCCC;">
                                                                                                <table style="width: 98%; background-color: #FFFFFF; height: 567px;">
                                                                                                    <tr>
                                                                                                        <td style="vertical-align: top" class="text-left">
                                                                                                <div style="overflow-y:scroll; height:555px; width:400px;">
                                                                                                <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#CCCCCC" BorderStyle="Solid" BorderWidth="3px" Font-Bold="True" Font-Names="Times New Roman" Font-Size="Medium" ForeColor="#0000CC" Height="552px" style="margin-top: 0px; font-size: small; color: #000000;" Width="418px" PageSize="12" ShowFooter="True">
                                                                                                    <Columns>

                                               
                                                                                                        <asp:BoundField DataField="HS10" HeaderText="HS10 CODE" >
                                                                                                        <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                                                                                        </asp:BoundField>
                                                                                                        <asp:BoundField DataField="CommodityName" HeaderText="COMMODITY NAME" />
                                                                                    ...
                                                                                    <asp:Chart ID="myChart" runat="server">
                                                                                        <series>
                                                                                            <asp:Series BorderWidth="5" ChartArea="MainChartArea" Color="Red" IsXValueIndexed="True" Name="Categories" YValuesPerPoint="2" ChartType="bar" IsValueShownAsLabel="True" LabelBackColor="Transparent" LegendText="Years">
                                                                                            </asp:Series>
                                                                                       ...
                                                                                       <titles>
                                                                                           <asp:Title Name="Raw Materials Analysis" Text="COMMODITY DATA ANALYSIS">
                                                                                            </asp:Title>
                                                                                       </titles>
                                                                                    </asp:Chart>
                                                                                               ...
                                                                                               <div style="overflow-y:scroll; height:219px; width:300px;">
                                                                                                   <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="White" BorderStyle="Solid" BorderWidth="3px" Font-Bold="True" Font-Names="Times New Roman" Font-Size="Medium" ForeColor="#0000CC" Height="91px" style="margin-top: 0px; font-size: small; color: #000000;" Width="271px" PageSize="8" ShowFooter="True">
                                                                                                    <Columns>
