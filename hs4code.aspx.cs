...
public partial class hs4code : System.Web.UI.Page
{
    Connect c;
    ...
    private void popGrid2()
    {
        ...
        c = new Connect();
        c.shola();
        c.com.CommandText = "SELECT Distinct [HS4] ,upper([HS4_Name]) as HS4_Name  FROM [CommodityDataSummary] ORDER by [HS4_Name]";
    ...
    private void popGrid2dpl()
    {
        ...
        c = new Connect();
        c.shola();
        c.com.CommandText = "SELECT Distinct [HS4] ,[HS4_Name] FROM [CommodityDataSummary] where HS4_Name='" + DropDownList1.Text.ToString() + "' ORDER by [HS4_Name]";
        c.adapt.SelectCommand = c.com;
        c.adapt.Fill(c.ds);
        //MessageBox.Show("Data Fetched");
        GridView2.DataSource = c.ds;
    ...
    private void popGriddpl()
    {
        ...
        c = new Connect();
        c.shola();
        c.com.CommandText = "SELECT [Year_R] ,sum(cast([Quantity_KG] as float)) as [Quantity_KG] ,sum(cast([Value_N] as float)) as [Value_N] FROM [CommodityDataSummary] where HS4_Name='" + DropDownList1.Text.ToString() + "' group by [Year_R]";
        c.adapt.SelectCommand = c.com;
        c.adapt.Fill(c.ds);
        //MessageBox.Show("Data Fetched");
        GridView1.DataSource = c.ds;
